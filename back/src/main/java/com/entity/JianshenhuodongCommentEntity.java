...
public class JianshenhuodongCommentEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public JianshenhuodongCommentEntity() {
		
	}
	
	public JianshenhuodongCommentEntity(T t) {
		try {
	...
	private Long jianshenhuodongId;
	 ...
	 * 设置：健身活动
	 */
	public void setJianshenhuodongId(Long jianshenhuodongId) {
		this.jianshenhuodongId = jianshenhuodongId;
	}
	/**
	 * 获取：健身活动
	 */
	public Long getJianshenhuodongId() {
		return jianshenhuodongId;
	}
	/**
	 * 设置：评论人
	 */
