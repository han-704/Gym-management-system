<template>
	...
	<div class="navbar" :style="{backgroundColor:heads.headBgColor,height:heads.headHeight,boxShadow:heads.headBoxShadow,lineHeight:heads.headHeight}">
		...
		<div class="right-menu">
			<div class="header-clock" :style="{color:heads.headFontColor,fontSize:'13px'}">
	...
	export default {
		...
		methods: {
			updateClock() {
				...
				this.headerTime = `${year}-${month}-${day} ${weekDay} ${hours}:${minutes}:${seconds}`
			},
			onLogout() {
