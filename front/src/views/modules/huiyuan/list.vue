    ...
    <div v-if="showFlag">
        ...
        <div class="header-content">
          <div class="header-left">
            ...
            <div class="header-text">
              <h2 class="header-title">会员信息管理</h2>
              <p class="header-desc">管理健身房会员信息</p>
            </div>
          </div>
          <div class="header-stats">
            <div class="stat-card">
              <i class="el-icon-postcard stat-icon"></i>
              <div class="stat-info">
      ...
      <div class="action-bar">
        <div class="action-left">
          <el-button v-if="isAuth('huiyuan','新增')" type="success" icon="el-icon-plus" class="add-btn" @click="addOrUpdateHandler()">新增会员</el-button>
          <el-button 
            type="danger" 
            icon="el-icon-delete" 
            class="del-btn" 
      ...
      <div class="table-card">
        ...
        >
          ...
          <el-table-column prop="huiyuanzhanghao" header-align="center" align="center" label="会员账号" min-width="120">
            <template slot-scope="scope">
              <div class="cell-user">
                <div class="user-avatar" :style="{background: getAvatarColor(scope.row.huiyuanxingming)}">
                  {{ getAvatarText(scope.row.huiyuanxingming) }}
                </div>
                <span class="account-text">{{ scope.row.huiyuanzhanghao || '-' }}</span>
              </div>
            </template>
          </el-table-column>
          <el-table-column prop="huiyuanxingming" header-align="center" align="center" label="会员姓名" min-width="90">
            <template slot-scope="scope">
              <span class="cell-name">{{ scope.row.huiyuanxingming || '-' }}</span>
            </template>
          </el-table-column>
          <el-table-column prop="shenfenzheng" header-align="center" align="center" label="身份证" min-width="160">
            <template slot-scope="scope">
              <span class="cell-idcard">{{ scope.row.shenfenzheng || '-' }}</span>
            </template>
          </el-table-column>
          ...
          <el-table-column width="420" align="center" fixed="right" label="操作" class-name="action-column">
            <template slot-scope="scope">
              <div class="action-buttons">
                ...
                <el-button type="text" icon="el-icon-bank-card" class="action-link action-card" @click="huiyuankaCrossAddOrUpdateHandler(scope.row,'cross')">申请会员卡</el-button>
                <el-button v-if="isAuth('huiyuan','记录健身活动') && role !== '管理员'" type="text" icon="el-icon-running" class="action-link action-sport" @click="jianshenhuodongCrossAddOrUpdateHandler(scope.row,'cross')">记录健身</el-button>
