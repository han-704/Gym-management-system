  ...
  <div class="main-content">
    ...
    <div class="page-header">
      <div class="header-left">
        <el-button type="primary" icon="el-icon-arrow-left" class="back-btn" @click="goBack()">返回</el-button>
        <div class="page-title">
          <i class="el-icon-user"></i>
          <h2>我的健身活动</h2>
        </div>
        <div class="page-subtitle">管理您发布的健身活动记录</div>
      </div>
        ...
        <div class="stats-cards">
          <div class="stat-item stat-records">
            ...
            <div class="stat-info">
              ...
              <span class="stat-label">我的活动</span>
            </div>
          </div>
      ...
      <div class="action-bar">
        ...
        <div class="action-bar-right">
          <el-tooltip content="刷新列表" placement="top">
            <el-button icon="el-icon-refresh" circle class="action-btn-circle" @click="getDataList()"></el-button>
          </el-tooltip>
        </div>
      </div>
          ...
          <el-table-column width="260" align="center" fixed="right" label="操作" class-name="action-column">
            <template slot-scope="scope">
              <div class="action-buttons">
                ...
                <el-button type="text" icon="el-icon-chat-dot-round" class="action-link action-comment" @click="commentHandler(scope.row)">评论</el-button>
              </div>
            </template>
          </el-table-column>
        </el-table>
...
export default {
  ...
  methods: {
    init() {},
    goBack() {
      this.$router.push('/jianshenhuodong');
    },
    getHuiyuanInfo() {
      this.$http({ url: "huiyuan/session", method: "get" }).then(({ data }) => {
        if (data && data.code === 0) {
          this.huiyuanInfo = data.data;
          this.getDataList();
        }
      });
    },
    getDataList() {
      ...
      if(this.huiyuanInfo && this.huiyuanInfo.huiyuanzhanghao) {
        params['huiyuanzhanghao'] = this.huiyuanInfo.huiyuanzhanghao;
      }
      this.$http({
