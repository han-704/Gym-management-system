<template>
  <div class="main-content fire-page">
    <!-- 列表页 -->
    <div v-if="showFlag">
      <!-- 页面头部 -->
        ...
        <div class="header-content">
          <div class="header-left">
            ...
            <div class="header-text">
              <h2 class="header-title">解聘管理</h2>
              <p class="header-desc">管理员工解聘记录信息</p>
            </div>
          </div>
          <div class="header-stats">
            <div class="stat-card">
              ...
              <div class="stat-info">
                ...
                <span class="stat-label">解聘记录</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="action-bar">
        <div class="action-left">
          <el-button type="success" icon="el-icon-plus" class="add-btn" @click="addOrUpdateHandler()">新增解聘</el-button>
          <el-button 
            type="danger" 
            icon="el-icon-delete" 
            class="del-btn" 
      ...
      <div class="table-card">
        <div class="table-container">
          ...
          >
            ...
            <el-table-column prop="jiepinbianhao" header-align="center" align="center" label="解聘编号" min-width="140">
              <template slot-scope="scope">
            ...
            <el-table-column prop="gonghao" header-align="center" align="center" label="工号" min-width="100">
              <template slot-scope="scope">
                <div class="cell-user">
            ...
            <el-table-column prop="jiaolianleixing" header-align="center" align="center" label="教练类型" min-width="100">
              <template slot-scope="scope">
                <span class="cell-type">{{ scope.row.jiaolianleixing || '-' }}</span>
              </template>
            </el-table-column>
            <el-table-column prop="jiaolianjiage" header-align="center" align="center" label="教练价格" min-width="100">
              <template slot-scope="scope">
                <span class="cell-price">
                  <i class="el-icon-coin"></i>
                  ¥{{ scope.row.jiaolianjiage || '0' }}
                </span>
              </template>
            </el-table-column>
            <el-table-column prop="jiepinshijian" header-align="center" align="center" label="解聘时间" min-width="120">
              <template slot-scope="scope">
            ...
            <el-table-column width="260" align="center" fixed="right" label="操作" class-name="action-column">
              <template slot-scope="scope">
                <div class="action-buttons">
                  <el-button type="text" icon="el-icon-tickets" class="action-link action-info" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
